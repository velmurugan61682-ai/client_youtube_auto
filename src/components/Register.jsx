      ...
      >
        <div className="bg-white border border-[#e5e5e5] rounded-[22px] p-6 sm:p-8 md:p-10 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] relative overflow-hidden text-zinc-900">
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.01 }}
            whileTap={{ scale: 0.99 }}
            className="w-full bg-white hover:bg-zinc-50 border border-zinc-200 text-zinc-700 font-bold py-3.5 px-4 rounded-xl transition-all flex items-center justify-center gap-3 text-sm shadow-sm hover:shadow active:scale-[0.99] disabled:opacity-50"
          >
            {googleLoading ? (
              <>
